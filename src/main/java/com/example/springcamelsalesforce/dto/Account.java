...
public class Account extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField59 = createField("CustomerPriority__c", "Customer Priority", "picklist", "xsd:string", 255, false, true, false, false, true, false, false);
        fields1.add(sObjectField59);
        final SObjectField sObjectField60 = createField("SLA__c", "SLA", "picklist", "xsd:string", 255, false, true, false, false, true, false, false);
        fields1.add(sObjectField60);
        final SObjectField sObjectField61 = createField("Active__c", "Active", "picklist", "xsd:string", 255, false, true, false, false, true, false, false);
        fields1.add(sObjectField61);
        final SObjectField sObjectField62 = createField("NumberofLocations__c", "Number of Locations", "double", "xsd:double", 0, false, true, false, false, true, false, false);
        fields1.add(sObjectField62);
        final SObjectField sObjectField63 = createField("UpsellOpportunity__c", "Upsell Opportunity", "picklist", "xsd:string", 255, false, true, false, false, true, false, false);
        fields1.add(sObjectField63);
        final SObjectField sObjectField64 = createField("SLASerialNumber__c", "SLA Serial Number", "string", "xsd:string", 10, false, true, false, false, true, false, false);
        fields1.add(sObjectField64);
        final SObjectField sObjectField65 = createField("SLAExpirationDate__c", "SLA Expiration Date", "date", "xsd:date", 0, false, true, false, false, true, false, false);
        ...
        sObjectDescriptionUrls1.setApprovalLayouts("/services/data/v35.0/sobjects/Account/describe/approvalLayouts");
        sObjectDescriptionUrls1.setCompactLayouts("/services/data/v35.0/sobjects/Account/describe/compactLayouts");
        sObjectDescriptionUrls1.setDescribe("/services/data/v35.0/sobjects/Account/describe");
        sObjectDescriptionUrls1.setLayouts("/services/data/v35.0/sobjects/Account/describe/layouts");
        sObjectDescriptionUrls1.setListviews("/services/data/v35.0/sobjects/Account/listviews");
        sObjectDescriptionUrls1.setQuickActions("/services/data/v35.0/sobjects/Account/quickActions");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v35.0/sobjects/Account/{ID}");
        sObjectDescriptionUrls1.setSobject("/services/data/v35.0/sobjects/Account");
        sObjectDescriptionUrls1.setUiDetailTemplate("https://keithkroculick2-dev-ed.my.salesforce.com/{ID}");
        sObjectDescriptionUrls1.setUiEditTemplate("https://keithkroculick2-dev-ed.my.salesforce.com/{ID}/e");
        sObjectDescriptionUrls1.setUiNewRecord("https://keithkroculick2-dev-ed.my.salesforce.com/001/e");
